...
const gallery = {
    settings: {
        ...
        openedImageNoImage: 'images/gallery/noimage.png',
    ...
    containerClickHandler(event) {
        ...
        this.openedImageElement = event.target;
    ...
    openImage(src) {
        ...
        // если не существует такой картинки то запускаем метод this.setSrcImageNoImage()
        image.onerror = () => this.setSrcImageNoImage();
    },

    /**
     * устанавлеваем src значение из this.settings.openedImageNoImage
     */
    setSrcImageNoImage(){
        event.target.src = this.settings.openedImageNoImage;
    },
    ...
    createScreenContainer() {
        ...
        backImageElement.addEventListener('click', () => this.back());
    ...
    /**
     * Переходим к следующей картинки
     */
    next() {
        const next = this.openedImageElement.nextElementSibling;
        this.openedImageElement = next === null ?
            this.openedImageElement.parentElement.firstElementChild : this.openedImageElement = next;
        this.openImage(this.openedImageElement.dataset.full_image_url);
    },

    /**
     * Переходим к предыдущей картинки
     */
    back() {
        const back = this.openedImageElement.previousElementSibling;
        this.openedImageElement = back === null ?
            this.openedImageElement.parentElement.lastElementChild : this.openedImageElement = back;
        this.openImage(this.openedImageElement.dataset.full_image_url);
    },
