...
(function snakeGame () {
    ...
    const snake = {
         ...
         * @param {int} maxX максимальная точка по x.
         * @param {int} maxY максимальная точка по y.
         */
        ...
        /**
         * Отдает точку, где будет голова змейки, если она заходит за края поля
         * @param {{x: int, y: int}} point - координаты головы змейки
         * @returns {{x: int, y: int}} point - Следующая точка куда придет змейка сделав шаг.
         */
        getNextPoint(point) {
    ...
    return game.init({speed: 5, winFoodCount: 10});
})();
